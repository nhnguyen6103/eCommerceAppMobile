...
import com.example.ecommerceappmobile.databinding.ViewholderBranchBinding
...
class BrandAdapter(val items: MutableList<BrandModel>) :
    ...
    class Viewholder(val binding: ViewholderBranchBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BrandAdapter.Viewholder {
        ...
        val binding=ViewholderBranchBinding.inflate(LayoutInflater.from(context),parent,false)
